  ...
  return (
    <div className="bg-white px-2 pt-3 sm:px-4 lg:px-4">
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8 max-w-[1400px] mx-auto">
        <div className="bg-gradient-to-r from-[#0f2c59] to-[#1e3a8a] rounded-[2rem] overflow-hidden shadow-2xl relative group">
          {/* Decorative shapes */}
          <div className="absolute top-0 right-0 w-64 h-64 bg-white/5 rounded-full transform translate-x-1/2 -translate-y-1/2 blur-2xl group-hover:scale-110 transition-transform duration-700 pointer-events-none"></div>
          <div className="absolute bottom-0 left-0 w-48 h-48 bg-[#0ea5e9]/20 rounded-full transform -translate-x-1/2 translate-y-1/2 blur-2xl group-hover:scale-110 transition-transform duration-700 pointer-events-none"></div>
            ...
            const testimonials = [
              {
                ...
                initial: "A",
                text: '"MSA Trading & Services made our company registration in Qatar incredibly smooth. Their team handled all the complex paperwork efficiently. Highly recommended!"'
              },
              {
                name: "Fatima Al-Kuwari",
                role: "Marketing Executive",
                initial: "F",
                text: '"Their PRO services are unmatched. From visa processing to document attestation, they are reliable, transparent, and always deliver on time."'
              },
              {
                name: "Mohammed Imran Khan",
                role: "Managing Director",
                initial: "M",
                text: '"The level of professionalism and dedication shown by the MSA team is truly exceptional. We couldn\'t have asked for a better partner."'
              },
              {
                name: "Ayesha Parveen",
                role: "HR Manager",
                initial: "A",
                text: '"Absolutely brilliant service from start to finish. They took all the stress out of our corporate setup process."'
              },
              {
                name: "Rahul Sharma",
                role: "Business Development Manager",
                initial: "R",
                text: '"MSA’s deep understanding of the local market and regulations has been instrumental in our successful expansion in Qatar."'
              },
              {
                name: "Daniel Smith",
                role: "IT Consultant",
                initial: "D",
                text: '"Efficient, responsive, and incredibly knowledgeable. They have been a crucial part of our operations and smooth business setup."'
              },
              {
                name: "George Haddad",
                role: "General Manager",
                initial: "G",
                text: '"Partnering with MSA Trading was the best decision for our business setup. Their end-to-end support is simply unparalleled."'
              }
            ];
