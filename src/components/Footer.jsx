...
const Typewriter = ({ text, delay = 70, pause = 2000 }) => {
  ...
  return (
    <span>
      {currentText}
      <span className="inline-block w-[3px] h-[1em] bg-current ml-1 -mb-1 animate-[pulse_1s_ease-in-out_infinite] text-[#009b4d]"></span>
    </span>
  );
};
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="flex flex-col md:flex-row justify-between items-center pb-10 border-b border-white/10 mb-12 text-center md:text-left">
          ...
          <div className="mt-6 md:mt-0 shrink-0">
            <a href="tel:+97430001016" className="inline-flex items-center gap-2 bg-[#009b4d] hover:bg-[#007f3f] text-white px-6 py-2.5 rounded-full font-bold transition-colors">
          ...
          <div className="md:col-span-1 lg:col-span-4 flex flex-col items-center md:items-start text-center md:text-left">
            <div className="flex items-center justify-center md:justify-start gap-2 mb-6">
              ...
              <div className="flex flex-col text-left">
                ...
                <span className="text-sm font-semibold tracking-widest text-[#009b4d] mt-1">AND SERVICES</span>
              </div>
            </div>
            ...
            <div className="flex items-center justify-center md:justify-start gap-3">
              <a href="#" className="w-9 h-9 rounded-full border border-white/20 flex items-center justify-center text-white hover:bg-[#009b4d] hover:border-[#009b4d] transition-all">
            ...
            <div className="bg-white rounded-2xl p-6 text-gray-800 shadow-xl text-center md:text-left">
              ...
              <ul className="space-y-4 flex flex-col items-center md:items-start">
                <li className="flex flex-col md:flex-row items-center md:items-start gap-2 md:gap-3">
                  <Phone className="w-5 h-5 text-[#009b4d] shrink-0 mt-0.5" />
                ...
                <li className="flex flex-col md:flex-row items-center md:items-start gap-2 md:gap-3">
                  <Mail className="w-5 h-5 text-[#009b4d] shrink-0 mt-0.5" />
                  <p className="text-sm font-medium text-gray-600 leading-relaxed">
                    info@msatrading.qa
                  </p>
                </li>
                <li className="flex flex-col md:flex-row items-center md:items-start gap-2 md:gap-3">
                  <MapPin className="w-5 h-5 text-[#009b4d] shrink-0 mt-0.5" />
                  <p className="text-sm font-medium text-gray-600 leading-relaxed">
